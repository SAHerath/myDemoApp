      ...
      <div id="tbl_data_list">
        ...
        <div class="table-wrap">
          <div class="table">
            <div class="thead">
              <div class="tr">
                <div class="th" id="dl_sort_1" style="width: 80px;">RANK<i class="fas fa-exchange-alt fa-rotate-90"></i></div>
                <div class="th" id="dl_sort_2">NAME<i class="fas fa-exchange-alt fa-rotate-90"></i></div>
                <div class="th" id="dl_sort_3">COUNTRY<i class="fas fa-exchange-alt fa-rotate-90"></i></div>
                <div class="th" id="dl_sort_4" style="width: 140px;">NO. STUDENTS<i class="fas fa-exchange-alt fa-rotate-90"></i></div>
                <div class="th" id="dl_sort_5" style="width: 100px;">STUDENT STAFF RATIO</div>
                <div class="th" id="dl_sort_6" style="width: 100px;">YEAR<i class="fas fa-exchange-alt fa-rotate-90"></i></div>
              </div>
            </div>
...
<script type="text/javascript">
  const urlroot = "<?php echo URLROOT; ?>Universities/";
  /////////////////////////////////////////////////////////////////////////////
  ...
  function createTblRow(dataRow) {
    ...
    tblRow.className = "tr";
    tblRow.dataset.rowId = dataRow["rank"];
    ...
    span1.textContent = dataRow["rank"];
    ...
    span2.textContent = dataRow["name"];
    ...
    span3.textContent = dataRow["country"];
    ...
    span4.textContent = dataRow["num_students"];
    ...
    span5.textContent = dataRow["student_staff_ratio"];
    ...
    span6.textContent = dataRow["year"];
  ...
  let dataList = new DataList(`${urlroot}getUniversitiesDataset`, displayData);
  dataList.setControls("dl_prev", "dl_next");
  dataList.setDetail("dl_detail");
  dataList.setSortHeader("dl_sort_1", "dl_sort_2", "dl_sort_3", "dl_sort_4", "dl_sort_6");
